      ...
      <div className="project-card-grid">
        <div className="project-card-container">
          ...
          <div className="project-card-info-container">
            ...
            <p className="project-card-description">
              ...
              in seed funding, they're well on their way to changing the world
              for the better.
            </p>
        ...
        <div className="project-card-container">
          ...
          <div className="project-card-info-container">
            ...
            <p className="project-card-description">
              ...
              intuitive and author. The creation of the website led to an
              increase in book sales by over 100% in the 2021 financial year.
            </p>
            <div className="project-card-links-container">
              <a
                className="project-card-link"
        ...
        <div className="project-card-container">
          ...
          <div className="project-card-info-container">
            ...
            <p className="project-card-description">
              Create maps, share them with your friends and blast your way
              through hordes of monsters! I spearheaded the design, development
              and launch of the Seismic expansion pack in 2017 while working at{" "}
              <a href="https://www.blowfishstudios.com/" target="blank">
                Blowfish Studios
              </a>
              .
