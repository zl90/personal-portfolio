        ...
        <div className="project-card-container">
          ...
          <div className="project-card-info-container">
            ...
            <p className="project-card-description">
              ...
              cryptocurrency articles from many sources, stores them and serves
              them to clients in JSON form. Clients can freely GET all
              articles/comments, and POST comments on each article. JSON Web
              Tokens are used to authenticate Admin users. Frontend coming soon!
            </p>
        ...
        <div className="project-card-container">
          ...
          <div className="project-card-info-container">
            ...
            <p className="project-card-description">
              ...
              manufacturers, and categories, and allows them to add these parts
              to a list to plan out their build. Additionally, users can upload
              images for each PC part. Plan your next PC build today!
            </p>
            <div className="project-card-links-container">
              <a
                className="project-card-link"
        ...
        <div className="project-card-container">
          ...
          <div className="project-card-info-container">
            ...
            <p className="project-card-description">
              ...
              quantities. Users can also filter product types in the Shop page.
              I built this project to get familiar with using React Hooks, React
        ...
        <div className="project-card-container">
          ...
          <div className="project-card-info-container">
            ...
            <p className="project-card-description">
              ...
              and the MUI framework. See if you can click all 25 cards!
            </p>
            <div className="project-card-links-container">
              <a
                className="project-card-link"
        ...
        <div className="project-card-container">
          ...
          <div className="project-card-info-container">
            ...
            <p className="project-card-description">
              ...
              weather conditions in this user-friendly, mobile-responsive
              webapp. Weather data is pulled from the{" "}
