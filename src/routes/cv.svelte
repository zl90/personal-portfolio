...
<div class="container">
    ...
    <main class="cv-main">
        ...
        <h3 class="cv-sub-heading">
            [ <a target="_blank" rel="noreferrer" href="https://www.uow.edu.au/">UNIVERSITY OF WOLLONGONG</a> ]
        </h3>
        <p class="cv-position">
        ...
        <br />
        <h3 class="cv-sub-heading">
            [ <a target="_blank" rel="noreferrer" href="https://www.blowfishstudios.com/">BLOWFISH STUDIOS</a> ]
        </h3>
        <p class="cv-position">
